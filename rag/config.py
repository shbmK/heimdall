...
class RagConfig:
    ...
    hybrid_alpha: float = field(default_factory=lambda: _env_float("HYBRID_ALPHA", 0.7))
    max_chunks_per_doc: int = field(default_factory=lambda: _env_int("MAX_CHUNKS_PER_DOC", 2))
